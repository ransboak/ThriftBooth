...
if (isset($_GET['search']) && isset($_GET['submit'])) {
    ...
    $query = "SELECT * FROM products WHERE product LIKE '%$search%' ORDER BY date_time DESC";
    $products = mysqli_query($connection, $query);
    $product_number = mysqli_num_rows($products);
} else {
...
<div class="product-container">
    <div class="container">
        ...
        <div class="product-main">
            <h2 class="title page-2">Search Results
