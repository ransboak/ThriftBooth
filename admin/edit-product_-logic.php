...
if (isset($_POST['submit'])) {
    ...
    $previous_thumbnail_2_name = filter_var($_POST['previous_thumbnail_2_name'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if (!$product) {
        ...
        if ($thumbnail_2['name']) {
            $previous_thumbnail_2_path = '../images/' . $previous_thumbnail_2_name;
            if ($previous_thumbnail_2_path) {
                unlink($previous_thumbnail_2_path);
            }
    ...
    if ($_SESSION['edit-product']) {
        //redirect to manage products page if roem is invalid
